...
<body oncontextmenu="return false;">
	...
	<div id="page-container" class="main-content-boxed">
		...
		<main id="main-container">
			...
			<div class="bg-image" style="background-image: url(<?= base_url('assets/public/images/manlan_terbaru.jpg') ?>); background-size: contain; background-repeat: no-repeat">
							...
							<div class="block block-themed block-rounded block-shadow">
								...
								<div class="block-content">
									...
									<div class="form-group row">
										...
										<div style="color: #735698; font-size: 10px; " class=" px-4 mt-5">

											<p>- Untuk jurusan Informatika, Sistem Informasi, Sistem Komputer dan Manajemen Informatika pilih option calon programmer</p>
										</div>
									</div>
									<div class="form-group row">
										<div class="col-12">
									...
									<div style="color: #735698; font-size: 10px; " class=" mt-5">

										<p>- Password maksimal 6 karakter, password dilarang mengandung simbol selain huruf dan angka, serta password dianjurkan menggunakan huruf kecil</p>
