		...
		<div class="col-md-6 col-xl-4">
			<div class="block-content block-content-full clearfix">
				<div class="float-left">
					...
					<div class="font-w600 text-success mb-5">Tanggal Ujian : 27 - 28 November</div>
				</div>
			</div>
		</div>
		<table class="table table-bordered table-vcenter mb-30">
			...
			<tr>
				<td class="text-center">
					...
					<a type="button" href="http://bit.ly/3Um6XKV" target="_blank" class="block-content block-content-full block-content-sm btn btn-outline-success" data-toggle="tooltip" title="Lihat Soal">
						Lihat Soal Ujian Asisten
					</a>
					<?php
					}
					else if($this->session->userdata('sebagai') == 'calonprogrammer'){?>
					<a type="button" href="http://bit.ly/3OVo6dx" target="_blank" class="block-content block-content-full block-content-sm btn btn-outline-success" data-toggle="tooltip" title="Lihat Soal">
