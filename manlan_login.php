...
<div id="page-container" class="main-content-boxed">
	...
	<main id="main-container">
		...
		<div  class="bg-image" style="background-image: url(<?=base_url('assets/public/images/manlan_terbaru.jpg')?>); background-repeat: no-repeat">
							...
							<div class="block block-themed block-rounded block-shadow">
									...
									<div class="form-group row">
										...
										<div class="col-12">
											...
											<!-- <span class="text-black">
												<span class="text-primary"><b>Calon Asisten</b></span>
												<br>username : calonasisten<br>password : 123456
											</span>
											<br><br>
											<span class="text-black">
												<span class="text-primary"><b>Calon Programmer</b></span>
												<br>username : calonprogrammer<br>password : 123456
											</span>
											<br><br>
											<span class="text-black">
												<span class="text-primary"><b>Asisten</b></span>
												<br>username : asisten<br>password : 123456
											</span>
											<br><br>
											<span class="text-black">
												<span class="text-primary"><b>Programmer</b></span>
												<br>username : programmer<br>password : 123456
											</span>
											<br><br>
											<span class="text-black">
												<span class="text-primary"><b>Staff</b></span>
												<br>username : staff<br>password : 123456
											</span> -->
								...
								<div class="block-content bg-body-light">
									...
									<div class="form-group text-center">
										...
										<!-- <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="<?=base_url('oprec/pengumuman')?>">
